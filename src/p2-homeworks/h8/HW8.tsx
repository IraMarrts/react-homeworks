...
import {checkUpPeople, homeWorkReducer, sortPeople} from './bll/homeWorkReducer'
...
function HW8() {
    ...
    const finalPeople = people.map((p: UserType) => (
        <div key={p._id} className={s.columns}>
            <span>{p.name}</span>
            {p.age}
        </div>
    ))
    ...
    const checkAge = () => setPeople(homeWorkReducer(initialPeople, checkUpPeople(18)))
    return (
        <div>
            <hr/>
            homeworks 8
